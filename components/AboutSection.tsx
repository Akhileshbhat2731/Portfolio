...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="relative min-h-screen bg-[#0C0C0C] px-5 sm:px-8 md:px-10 py-20 flex flex-col justify-center items-center overflow-hidden">
      ...
      {/* Main Content */}
      <div className="max-w-4xl w-full text-center flex flex-col items-center gap-10 sm:gap-14 md:gap-16 z-20">
        <FadeIn delay={0} y={40}>
          <h2
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
          <AnimatedText
            text="Software Test Engineer with hands-on experience in manual testing, test case design, defect life cycle management, and SDLC/STLC processes. I work directly with developers to resolve issues, validate fixes, and support quality across concurrent projects."
